# -*- coding: utf-8 -*-
"""
Created on Wed Jan 11 11:41:24 2017
...
def beta_mcmc(N_hops, a, b):
    ...
    for i in range(0, N_hops):
        states.append(cur)
        next_ = random.uniform(0, 1)
        ap = min(beta_pdf(next, a, b) / beta_pdf(cur, a, b), 1)  # 计算接受概率
        if transform(ap):
            cur = next_
...
def plot_beta(a, b):
    ...
    plt.hist(beta_mcmc(100000, a, b), normed=True, bins=25,
