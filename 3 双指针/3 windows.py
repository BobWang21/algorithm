...
def min_window2(s, t):
    target = Counter(t)  # 使用Counter来替代unordered_map<char, int>
    cnt = defaultdict(int)  # 使用defaultdict来替代unordered_map<char, int>
...
if __name__ == '__main__':
    ...
    print('\n最小覆盖子串')
    print(min_window1('aaaaaaaaaaaabbbbbcdd', 'abcdd'))
